...
namespace Cantina
{
    public partial class frmFuncionarios : Form
    {
        ...
        {
            MySqlCommand comm = new MySqlCommand();
            comm.CommandText = "updade tbFuncionarios set nome = @nome,email = @email,cpf = @cpf,telCelular = @telCelular,cep = @cep,endereco = @endereco,numero = @numero,bairro = @bairro,estado = @estado where cpdFunc = @codFunc;";
            comm.CommandType = CommandType.Text;
            ...
            comm.Parameters.Add("@cidade", MySqlDbType.VarChar, 100).Value = txtCidade.Text;
            comm.Parameters.Add("@estado", MySqlDbType.VarChar, 2).Value = cbbEstado.Text;
            comm.Parameters.Add("@codFunc", MySqlDbType.UInt32, 11).Value = codFunc;
